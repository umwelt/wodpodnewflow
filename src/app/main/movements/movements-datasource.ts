  ...
  private getSortedData(data: MovementsItem[]) {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort.active) {
        case 'equipments': return compare(a.equipments.name, b.equipments.name, isAsc);                        
        case 'secondary_muscles': return compare(a.secondary_muscles.name, b.secondary_muscles.name, isAsc);                
        case 'primary_muscles': return compare(a.primary_muscles.name, b.primary_muscles.name, isAsc);        
